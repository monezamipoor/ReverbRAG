...
if dataset == 'SoundSpaces':
    ...
    datamanager = SoundSpacesDataManagerConfig(train_num_rays_per_batch=2100,
            eval_num_rays_per_batch=2100,
            fs=fs,
            max_len=max_len,
    ...
    datamanager = RAFDataManagerConfig(train_num_rays_per_batch=2100,
            eval_num_rays_per_batch=2100,
            fs=fs,
            max_len=max_len,
...
start_step_audio = 500 # number of iterations NeRF has been trained before starting audio training
# ----
...
NeRAF_method = MethodSpecification(
    ...
    pipeline=NeRAFPipelineConfig(
        ...
        audio_model=NeRAFAudioModelConfig(
            ...
            max_len=max_len,
            reference_mode = reference_mode,
            loss_weights={"mse": 0.0, "sl_mse": 1.0, "sc": 1.0, "edc": 0.2, "mask_l1": 0.0, "mask_spl": 0.0},
            edc_T=60,
            edc_normalize=True
        ),
